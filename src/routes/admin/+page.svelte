...
{:else}
    <NoResult title="No routes" subTitle="" href="/admin/routes/new" hrefText="Create new route"/>
{/if}
...
{#if $USERS.length > 0}
    ...
    <Users users={$USERS}/>
{:else}
    <NoResult title="No users" subTitle="" href="/admin/users/new" hrefText="Create user"/>
{/if}
