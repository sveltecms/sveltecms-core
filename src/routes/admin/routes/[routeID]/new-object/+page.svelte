<script lang="ts">
    ...
    let apiPath = `/routes/${data.routeData.ID}/objects/create`
    /** Indicate if we are adding or updating */
    const addingNewObject = true
    ...
    async function handlePublish() {
        ...
        const apiLoadData:CreateRouteObjectLoad = { elements:routeData.elements }
        const apiResponse:CreateRouteObjectRes = await postJson(apiPath,apiLoadData)
