<script lang="ts">
    ...
    $: isARoute = currentPathname.includes("/admin/routes")
    ...
    const atributes = { "data-sveltekit-prefetch":"", "data-label-right":"", "data-label":text }
</script>

<a {href} {...atributes} class="link" class:active on:click={()=>IS_NAV_OPEN.set(false)}>
    <div class="icon">
