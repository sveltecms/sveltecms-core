<script lang="ts">
    ...
    import type { AssetDeleteLoad,AssetDeleteRes,AssetUpdateLoad,AssetUpdateRes } from "$Types/api";
    ...
    async function UpdateAsset() {
        ...
        const apiLoad:AssetUpdateLoad = assetToEdit
        const apiResponse:AssetUpdateRes = await postJson("/assets/update",apiLoad)
    ...
    async function deleteAsset() {
        ...
        const apiLoad:AssetDeleteLoad = assetToEdit
        const apiResponse:AssetDeleteRes = await postJson("/assets/delete",apiLoad)
